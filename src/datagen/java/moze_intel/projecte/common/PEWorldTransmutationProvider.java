...
public class PEWorldTransmutationProvider extends WorldTransmutationProvider {
	...
	protected void addWorldTransmutations(@NotNull HolderLookup.Provider registries) {
		createTransmutationBuilder(PECore.rl("defaults"))
				...
				.registerBiDirectional(Blocks.GRAVEL, Blocks.SANDSTONE)
				.registerBiDirectional(Blocks.ICE.defaultBlockState(), IceBlock.meltsInto())
				.registerBiDirectional(Blocks.OBSIDIAN.defaultBlockState(), Blocks.LAVA.defaultBlockState())
